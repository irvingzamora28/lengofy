    ...
    <AuthenticatedLayout
      header={
        <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
          {trans('Create New Noun List')}
        </h2>
      }
    >
      <Head title={trans('Create New Noun List')} />

      <div className="py-12">
        <div className="max-w-2xl mx-auto sm:px-6 lg:px-8">
          <Card>
            <CardHeader>
              <CardTitle>{trans('New Noun List')}</CardTitle>
              <CardDescription>
                {trans('Create a custom list to organize nouns for studying.')}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    placeholder={trans('e.g., Common Nouns, Animals, Food, etc.')}
                    className="mt-1"
                    required
                    maxLength={100}
                  />
