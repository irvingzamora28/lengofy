...
export default function Index({ lists }: Props) {
  ...
  return (
    <AuthenticatedLayout
      header={
        <div className="flex justify-between items-center">
          ...
          <Link href={route('noun-lists.create')}>
            <Button>
    ...
    >
      <Head title={trans('My Noun Lists')} />
              ...
              <CardContent className="pt-6">
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {trans('Create your first noun list to start organizing nouns for study.')}
                  </p>
                  <div className="mt-6">
                    <Link href={route('noun-lists.create')}>
                      <Button>
                ...
                <Card key={list.id} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      <Link
                        href={route('noun-lists.show', list.id)}
